...
const Profile = () => {
    ...
    const handleSaveProfile = async (e) => {
        ...
        try {
            const res = await axios.put('https://cityday-api.onrender.com/api/user/profile', formData, {
                headers: { Authorization: `Bearer ${token}` }
            });
            setUser(res.data.user);
            setIsEditing(false);
    ...
    const handleSetPin = async (e) => {
        ...
        try {
            await axios.post('https://cityday-api.onrender.com/api/user/set-withdrawal-pin', {
                pin: pinData.newPin,
